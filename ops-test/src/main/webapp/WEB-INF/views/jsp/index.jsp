          	 ...
          	 <div class="btn btn-danger"
				...
				<strong>Error! </strong> ${message} 
          	   ...
          	   <div class="row">
          	    <div class="container">
          	     <div class="col-md-6">
            <div class="panel panel-default" id="registerWindow" ng-controller="registerController">
              <form name="registerForm" ng-submit="saveCustomer(registerForm)" novalidate>
                <div class="panel-heading"> <strong class="">Request for a demo</strong>
                </div>
                <div class="panel-body">
	         		 <div class="row">
							<div class="col-sm-12 form-group">
								<label><i class="fa fa-envelope" aria-hidden="true"></i> <spring:message code="label.email" /></label>
						...
						<div class=" col-sm-12 form-group">
							<label><i class="fa fa-file-text-o" aria-hidden="true"></i> <spring:message code="label.message" /></label>
				...
				<div class="panel-footer">
					...
					<spring:message code="label.reset" var="labelReset"></spring:message>
				    <input  type="submit" class="btn btn-md btn-info pull-left" ng-disabled="registerForm.$invalid" value="${labelSubmit}"/>	
					<input type="reset" class="btn btn-md btn-default pull-left"	id="resetRegisterFormBtn" value="${labelReset}"/>
					</div>
					</div>
			</div>
									</form>
